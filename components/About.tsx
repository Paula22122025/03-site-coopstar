      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative order-2 lg:order-1">
            ...
            {/* Decoration */}
            <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-blue-600 rounded-3xl -z-10 rotate-6" />
            <div className="absolute -top-10 -left-10 w-32 h-32 bg-blue-100 rounded-full -z-10 animate-pulse" />
          </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <h3 className="text-4xl lg:text-5xl font-black text-slate-900 mb-8 leading-tight">
              Uma década movendo <span className="text-blue-600">São Paulo</span> com eficiência.
            </h3>
