    ...
    <section id="faq" className="py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-blue-600 font-bold uppercase tracking-widest text-sm mb-4">Dúvidas Frequentes</h2>
          <h3 className="text-4xl font-black text-slate-900 mb-6">FAQ</h3>
          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                ...
                {openIndex === index ? (
                  <MinusIcon className="text-blue-600" size={20} />
                ) : (
                  <PlusIcon className="text-slate-400" size={20} />
                )}
              </button>
              <AnimatePresence>
                {openIndex === index && (
