    ...
    <section id="services" className="py-24 bg-black">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-blue-500 font-bold uppercase tracking-widest text-sm mb-4">Nossos Serviços</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group p-8 rounded-3xl border border-blue-900/30 bg-slate-900/50 hover:bg-slate-900 hover:shadow-2xl hover:border-blue-700/50 transition-all cursor-default"
            >
              <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 transition-transform group-hover:scale-110 group-hover:rotate-3 ${
                service.color === "blue" ? "bg-blue-900/50 text-blue-400" :
                service.color === "green" ? "bg-green-900/50 text-green-400" :
                service.color === "purple" ? "bg-purple-900/50 text-purple-400" :
              ...
              <button className="flex items-center gap-2 text-sm font-bold text-blue-500 opacity-0 group-hover:opacity-100 transition-opacity">
